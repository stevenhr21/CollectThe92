      ...
      {LEAGUE_ORDER.map((league) => {
        ...
        return (
          ...
          >
            ...
            >
              <div
                className="rounded-md p-2 sm:p-2.5 md:p-3 h-full flex flex-col justify-center"
                style={{
              ...
              >
                <div className="flex items-center justify-between gap-2 mb-1.5">
                  ...
                  <p className="text-[8px] sm:text-[9px] uppercase tracking-[0.13em] text-white/70 whitespace-nowrap">
